...
key_array:	.word	0x72, 0x5a, 0x76 # down arrow, enter ###0x1C, 0x23, 0x1D, 0x1B   	# define as many scancodes here as you need
...
.eqv btns_mmio 0x10030010 		# from our memory map
